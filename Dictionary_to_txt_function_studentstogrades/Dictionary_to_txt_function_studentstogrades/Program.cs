...
//8. Define a static function which writes a student-to-grade dictionary to a text file.
//Test idea: run it, then open the file in notepad and check if it looks good.
class Program
{
    static void Main()
    {
        while (true)
        {
            List<string> studentNames = new List<string> { "santa maria de la burrito", "horhe", "3Pac", "The god emperor", "z_pee-pee-oh", "mrzim programiranje" };
    ...
    private static void ReadDictionaryText (string path)
    {
